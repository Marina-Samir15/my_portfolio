...
const translations = {
  ...
  ar: {
    ...
    "exp-4-desc": "تخصص في تصميم UI/UX والرسومات الرقمية باستخدام Adobe Creative Suite.",
    "exp-4-date": "2022 - 2023",
    ...
    "contact-loc": "الموقع",
    "contact-loc-val": "مصر",
    "footer-text": "&copy; 2026 مارينا سمير. بُني بحب <i class='fas fa-heart' style='color: var(--secondary)'></i> وروح الـ .NET."
  }
};
