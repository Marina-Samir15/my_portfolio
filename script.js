...
const translations = {
  en: {
    ...
    "hero-bio":
      "Full-Stack .NET Developer with a passion for creating responsive, user-friendly web applications.",
    "about-title": "About <span>Me</span>",
    "about-p1":
      "I am a <strong class='highlight'>Full-Stack .NET Developer</strong> with a solid foundation in Information Technology. Currently, I'm honing my expertise through the <strong class='highlight'>DEPI Initiative</strong>, focusing on building scalable and efficient web applications.",
    "about-p2":
      "With a background in <strong class='highlight'>Graphic Design</strong>, I ensure that my back-end logic is complemented by clean, user-friendly, and fully responsive interfaces.",
    ...
    "p1-title": "My Planner",
    "p1-desc":
      "A responsive planner web application for managing daily, weekly, monthly, and yearly tasks with notes section and analysis dashboard. Built with HTML5, CSS3, and JavaScript.",
    "p1-date": "Sep 2025",
    "p2-tag": "Task Management",
    "p2-title": "To-Do List",
    "p2-desc":
      "A responsive task management app with Dashboard, All Tasks, and Add Task pages, featuring task filtering, notifications, and local storage persistence.",
    "p2-date": "Aug 2025",
    "p3-tag": "Healthcare",
    "p3-title": "Care Connect",
    "p3-desc":
      "A web platform to explore hospitals, medical specialties, and doctors with easy contact features.",
    "p3-date": "Dec 2024",
    "p4-tag": "Landing Page",
    "p4-title": "Applight",
    ...
    "exp-1-desc":
      "Currently advancing my expertise in building scalable web applications using .NET technologies.",
    "exp-1-date": "NOV 2025 - Present",
    "exp-2-title": "Problem Solving Mentor",
    "exp-2-org": "NATU University",
    "exp-2-desc":
      "Mentoring students in problem-solving techniques and programming fundamentals.",
    "exp-2-date": "2025 - Present",
    "exp-3-title": "Java Programming Training",
    "exp-3-org": "Information Technology Institute (ITI)",
    "exp-3-desc":
      "Completed comprehensive Java programming course with focus on OOP and data structures.",
    "exp-3-date": "AUG 2024",
    "exp-4-title": "Graphic Design Specialist",
    "exp-4-org": "National Telecommunication Institute (NTI)",
    "exp-4-desc":
      "Specialized in UI/UX design and digital graphics with Adobe Creative Suite.",
    "exp-4-date": "JUN 2025",
    "service-1": "Front-End Development",
    "service-1-desc":
      "Turning designs into fast, responsive websites using HTML, CSS, and JavaScript.",
    "service-2": ".NET Development",
    "service-2-desc":
      "Building robust and scalable web applications using ASP.NET Core and Entity Framework.",
    "service-3": "Graphic Design",
    "service-3-desc":
      "Creating stunning visuals and brand identities using Adobe Creative Suite and Figma.",
    "service-4": "Database Management",
    "service-4-desc":
      "Designing and managing SQL Server databases for high performance and efficiency.",
    "contact-email": "Email",
    "contact-phone": "Phone",
  ...
  ar: {
    ...
    "hero-bio":
      "مطورة .NET متكاملة شغوفة بإنشاء تطبيقات ويب متجاوبة وسهلة الاستخدام.",
    "about-title": "من <span>أنا</span>",
    "about-p1":
      "أنا <strong class='highlight'>مطورة .NET متكاملة</strong> لدي أساس قوي في تكنولوجيا المعلومات. حالياً، أقوم بصقل خبراتي من خلال <strong class='highlight'>مبادرة DEPI</strong>، مع التركيز على بناء تطبيقات ويب قابلة للتوسع وفعالة.",
    "about-p2":
      "مع خلفية في <strong class='highlight'>التصميم الجرافيكي</strong>، أضمن أن المنطق البرمجي الخاص بي يُستكمل بواجهات نظيفة، سهلة الاستخدام، ومتجاوبة تماماً.",
    ...
    "p1-title": "My Planner",
    "p1-desc":
      "تطبيق مخطط ويب متجاوب لإدارة المهام اليومية والأسبوعية والشهرية والسنوية مع قسم للملاحظات ولوحة تحليلية.",
    "p1-date": "سبتمبر 2025",
    "p2-tag": "إدارة المهام",
    "p2-title": "قائمة المهام",
    "p2-desc":
      "تطبيق متجاوب لإدارة المهام مع لوحة رئيسية وجميع المهام وإضافة مهمة، مع تصفية وإشعارات وحفظ محلي.",
    "p2-date": "أغسطس 2025",
    "p3-tag": "الرعاية الصحية",
    "p3-title": "Care Connect",
    "p3-desc":
      "منصة ويب لاستكشاف المستشفيات والتخصصات الطبية والأطباء مع ميزات التواصل.  ",
    "p3-date": "ديسمبر 2024",
    "p4-tag": "صفحة ويب",
    "p4-title": "Applight",
    ...
    "exp-1-desc":
      "تطوير الخبرات في بناء تطبيقات ويب قابلة للتوسع باستخدام تقنيات .NET.",
    ...
    "service-1-desc":
      "تحويل التصاميم إلى مواقع ويب متجاوبة وسريعة باستخدام HTML، CSS، JavaScript.",
    "service-2": "تطوير .NET",
    "service-2-desc":
      "بناء تطبيقات ويب قوية وقابلة للتطوير باستخدام ASP.NET Core و Entity Framework.",
    "service-3": "تصميم جرافيك",
    "service-3-desc":
      "إنشاء تصاميم مبهرة وهويات علامات تجارية باستخدام Adobe Creative Suite و Figma.",
    "service-4": "إدارة قواعد البيانات",
    "service-4-desc":
      "تصميم وإدارة قواعد بيانات SQL Server لضمان أداء وكفاءة عالية.",
    "contact-email": "البريد الإلكتروني",
    "contact-phone": "الهاتف",
    "contact-loc": "الموقع",
    "contact-loc-val": "أسيوط",
    "footer-text":
      "&copy; 2026 مارينا سمير. بُني بحب <i class='fas fa-heart' style='color: var(--secondary)'></i>.",
  },
};
...
function updateLanguage(lang) {
  ...
  if (logoName) {
    logoName.innerHTML =
      lang === "en" ? "Marina <span>Samir</span>" : "مارينا <span>سمير</span>";
  }
...
function showOnlyThisSection(sectionId) {
  ...
  if (homeSection) {
    if (sectionId === "home") {
      ...
      homeSection.classList.add("active-section-display");
    } else {
      ...
      homeSection.classList.remove("active-section-display");
    }
  }

  controlledSections.forEach((id) => {
    if (id !== "home") {
      ...
      if (section) {
        if (id === sectionId) {
          ...
          section.classList.add("active-section-display");
        } else {
          ...
          section.classList.remove("active-section-display");
        }
      }
    }
  });
...
document.querySelectorAll('.nav-links a[href^="#"]').forEach((link) => {
  link.addEventListener("click", function (e) {
    ...
    showOnlyThisSection(targetId);

    const menuToggle = document.getElementById("menu-toggler");
    const navLinks = document.getElementById("nav-links");
    if (menuToggle && navLinks && window.innerWidth <= 992) {
      menuToggle.classList.remove("open");
      navLinks.classList.remove("active");
      document.body.style.overflow = "auto";
    }
...
document.addEventListener("DOMContentLoaded", () => {
  const originalLangUpdate = updateLanguage;

  updateLanguage = function (lang) {
    originalLangUpdate(lang);
    setTimeout(() => {
      showOnlyThisSection(activeSection);
    }, 100);
  };

  showOnlyThisSection("home");
...
if (viewWorkBtn) {
  viewWorkBtn.addEventListener("click", function (e) {
    e.preventDefault();
    showOnlyThisSection("projects");
  });
}

window.addEventListener("popstate", () => {
  const hash = window.location.hash.substring(1);
  if (hash && controlledSections.includes(hash)) {
    showOnlyThisSection(hash);
  } else {
    showOnlyThisSection("home");
  }
});
